        ...
        searchTimeout = setTimeout(() => {
            fetchData(url.geo(searchField.value), function (locations) {
             ...
             for (const { name, lat, lon, country, state } of locations) {
               const serachItem = document.createElement("li");
               serachItem.classList.add("view-item");
               ...
               searchResult.querySelector("[data-search-list]").appendChild(serachItem);
               items.push(serachItem.querySelector("[data-search-toggler]"));
             }
...
/**
 * Render all weather data in htnl page
